...
import 'package:kendaka_test/features/settings/presentation/views/widgets/add_or_edit_shipping_address_view_body.dart';
...
class AddOrEditShippingAddressView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const AddOrEditShippingAddressViewBody(),
    );
  }
}
